...
def correlation_spectral_global_mix(
    ...
    *,
    ...
    # Non-causal only: wraparound is intentional (a global circular mixer). The
    # causal case never reaches here -- a single Q/K-derived kernel cannot be
    # causal, so it returns the causal spectral low-pass fallback above.
